...
function LightBody(skeleton){
    ...
    this.update = function(data){
        ...
        if(self.skeleton) {
            ...
            this.lHand.setPosition(center.x+self.skeleton.handOffset.l.x,center.y+self.skeleton.handOffset.l.y);
            this.rHand.setPosition(center.x+self.skeleton.handOffset.r.x,center.y+self.skeleton.handOffset.r.y);
    ...
    this.coreL = new SpriteRing(this.sprite,rotSym,sprites.bubLt,coreOff,center,coreLRot,coreMag,0.2,colors.white);
    this.coreR = new SpriteRing(this.sprite,rotSym,sprites.bubLt,coreOff,center,coreLRot,coreMag,0.2,colors.white);
    this.core = new SpriteRing(this.sprite,coreSym,sprites.bubLt,coreOff,center,Math.PI,coreMag,0.6,this.secondaryColor);
